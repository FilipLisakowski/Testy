...
*/
    ...
    public void errorIsShown(){
       assertEquals("Logowanie nie powiod³o siê. SprawdŸ ponownie wpisywane has³o.", pages.login().messageCheck());
    }	
    ...
    public void userLogOutCheck(){
        assertEquals("Wylogowano. Zapraszamy kiedyœ ponownie.", pages.login().messageCheck());
    }	
